...
export const AUTH_CODES: AuthCode[] = [
  ...
  // 새로운 50크레딧 랜덤 코드 10개
  { code: 'STORM50Q', totalCredits: 50, description: '스톰 코드 (50크레딧)', tier: 'gold' },
  { code: 'BLAZE50R', totalCredits: 50, description: '블레이즈 코드 (50크레딧)', tier: 'gold' },
  { code: 'FROST50W', totalCredits: 50, description: '프로스트 코드 (50크레딧)', tier: 'gold' },
  { code: 'VIPER50T', totalCredits: 50, description: '바이퍼 코드 (50크레딧)', tier: 'gold' },
  { code: 'TITAN50Y', totalCredits: 50, description: '타이탄 코드 (50크레딧)', tier: 'gold' },
  { code: 'FLASH50U', totalCredits: 50, description: '플래시 코드 (50크레딧)', tier: 'gold' },
  { code: 'NOVA50I', totalCredits: 50, description: '노바 코드 (50크레딧)', tier: 'gold' },
  { code: 'CYBER50O', totalCredits: 50, description: '사이버 코드 (50크레딧)', tier: 'gold' },
  { code: 'MAGIC50P', totalCredits: 50, description: '매직 코드 (50크레딧)', tier: 'gold' },
  { code: 'LUNAR50S', totalCredits: 50, description: '루나 코드 (50크레딧)', tier: 'gold' },
